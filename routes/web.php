...
//     $password = bcrypt('barromadou');
//     echo $password;
// });
// Route::get('/add', function(){ return view('dashssboard.auth-temp.register'); }); 

Route::group(['middleware' => ['get.menu']], function () {
    Route::get('/dashboard', function () {           return view('dashboard.homepage'); })->name('dashboard');
    ...
    Route::group(['middleware' => ['role:admin']], function () {
      ...
      // Route::resource('/enreg',    [RegisterController::class, 'create'])->name('register');
