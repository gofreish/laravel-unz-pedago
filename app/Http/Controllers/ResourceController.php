...
class ResourceController extends Controller
{
    ...
    public function store($table, Request $request)
    {
        ...
        if($form->add == 1){
            ...
            LogsController::storeUserAction($form, 'Ressource : Ajout dans la table'.$form->name);
    ...
    public function show($table, $id, Request $request)
    {
        ...
        if($form->read == 1){
            $resourceService = new ResourceService();
            //dd($resourceService->show($form->id, $form->table_name, $id));
    ...
    public function update($table, $id, Request $request)
    {
        ...
        if($form->edit == 1){
            ...
            //Sauvegarde dans le log
            LogsController::storeUserAction($form->id, 'Ressource : Mis a jour dans la table'.$form->name);
    ...
    public function destroy($table, Request $request, $id)
    {
        ...
        if($form->delete == 1){
            if($request->has('marker')){
                ...
                //Sauvegarde dans le log
                LogsController::storeUserAction($form->id, 'Ressource : Suppression dans la table'.$form->name);
