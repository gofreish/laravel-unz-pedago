...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('/assets/brand/logo.png') }}" width="118" height="46" alt="Logo Université">
            <img class="c-sidebar-brand-minimized" src="{{ url('assets/brand/logo.png') }}" width="118" height="46" alt="CoreUI Logo">
        </div>
