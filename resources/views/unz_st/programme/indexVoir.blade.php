...
<div class="row">
  <div class="col-lg-12 text-center">
    ...
    @endif
    <div class="display-4"><span class="badge badge-secondary">Liste de tous les programmes</span></div>

    <!-- Tableau 1 pour les cours -->
    <div class="card">
      <div class="card-header"><i class="fa fa-align-justify"></i> <span class="badge badge-secondary"><h5><strong>Cours</strong></h5> </span> </div>
      <div class="card-body">
    ...
    <div class="card">
      <div class="card-header"><i class="fa fa-align-justify"></i> <span class="badge badge-secondary"><h5><strong>Examen</strong></h5></span> </div>
      <div class="card-body">
        <table class="table table-responsive-sm table-bordered table-striped table-sm">
          <thead>
            <tr>
    ...
    <div class="card">
      <div class="card-header"><i class="fa fa-align-justify"></i> <span class="badge badge-secondary"><h5><strong>Autre</strong></h5> </span> </div>
      <div class="card-body">
        <table class="table table-responsive-sm table-bordered table-striped table-sm">
          <thead>
            <tr>
