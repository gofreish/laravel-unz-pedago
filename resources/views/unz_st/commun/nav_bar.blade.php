...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('/assets/brand/coreui-base-whites.svg') }}" width="118" height="46" alt="Logo Université">
            <img class="c-sidebar-brand-minimized" src="{{ url('assets/brand/coreui-base-white.svg') }}" width="118" height="46" alt="CoreUI Logo">
        </div>
