          ...
          <div class="card mx-4">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('register') }}">
                    @csrf
                    <h1>{{ __('enregistrer') }}</h1>
                    <p class="text-muted">Creer un compte</p>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control" type="text" placeholder="{{ __('Prenom') }}" name="prenom" value="{{ old('prenom') }}" required autofocus>
                    </div>
            ...
            <div class="input-group mb-3">
                        ...
                        <input class="form-control" type="number" placeholder="{{ __('Telephone') }}" name="telephone" value="{{ old('telephone') }}" required autofocus>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control" type="text" placeholder="{{ __('Titre') }}" name="titre_id" value="{{ old('titre_id') }}" required autofocus>
                    </div>
